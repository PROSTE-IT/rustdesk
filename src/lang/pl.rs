...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Block user input", "Blokuj interakcje"),
        ("Unblock user input", "Odblokuj interakcje"),
        ("Tracking", "Śledzenie"),
        ("Disable tracking", "Wyłącz śledzenie"),
        ("All displays", "Wszystkie ekrany"),
        ("Select one display to enable tracking", "Wybierz jeden ekran, aby włączyć śledzenie"),
        ("Tracking requires at least two displays", "Śledzenie wymaga co najmniej dwóch ekranów"),
        ("Tracking requires RustDesk 1.2.4 or newer", "Śledzenie wymaga RustDesk 1.2.4 lub nowszego"),
        ("Tracking is not available on Android", "Śledzenie nie jest dostępne na Androidzie"),
        ("Tracking is not available on Wayland", "Śledzenie nie jest dostępne w Wayland"),
        ("Tracking is not available with an embedded cursor", "Śledzenie nie jest dostępne przy osadzonym kursorze"),
        ("Tracking is unavailable when displays use separate windows", "Śledzenie nie jest dostępne, gdy ekrany używają osobnych okien"),
        ("Blocking interactions is not available for this connection", "Blokowanie interakcji nie jest dostępne dla tego połączenia"),
        ("Ctrl+Alt+Del is not available for this connection", "Ctrl+Alt+Del nie jest dostępne dla tego połączenia"),
        ("File transfer is not available for this connection", "Transfer plików nie jest dostępny dla tego połączenia"),
        ("Lock screen is not available for this connection", "Blokada ekranu nie jest dostępna dla tego połączenia"),
        ("Display switching disabled", "Przełączanie ekranów jest niedostępne"),
